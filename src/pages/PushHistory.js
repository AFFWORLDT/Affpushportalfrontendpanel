...
const PushHistory = () => {
    ...
    return (
        <>
            ...
            <h1 className='text-center'>Push History here!!</h1>
                                    ...
                                    <>
                                        {history?.map((rowData) => (
                                            <TableRow key={rowData?.affiliate_id}>
                                                <TableCell align="center" key={rowData?.icon}   > <img src={rowData?.icon} alt="icon" style={{ width: 100 }} /> </TableCell>
                                                <TableCell align="center">{rowData?.body}</TableCell>
                                                <TableCell align="center">{rowData?.title}</TableCell>

                                                <TableCell align="center"> <Link target="_blank" rel="noopener" href={rowData?.clickAction} variant="body2" style={{ textDecoration: 'none' }} >
                                                    Check Here!!
                                                </Link>  </TableCell>
                                                <TableCell align="center">{rowData?.success === true ? <CloudDoneIcon color="success" /> : <CloseIcon color="error" />}</TableCell>
                                                <TableCell align="center"> <Link target="_blank" rel="noopener" href={rowData?.website_url} style={{ textDecoration: 'none' }} variant="body2">
                                                    URL
                                                </Link>  </TableCell>
